...
den_with_mitos_df_summary = den_with_mitos_df[[comparison, "Layer", "Mito_total_area", "Den_Width_um", "Den_Length_um", "Den_Area_um_sq", "Total_mito_area_per_den_area"]].groupby([comparison, "Layer"]).agg(["mean", "median", "std", "count"]).T
...
den_with_mitos_group = den_with_mitos_df[[comparison, "Layer", "Tile", "Dendrite_ID", "Den_Area_um_sq", "Den_Length_um", "Den_Width_um"]].groupby([comparison, "Layer"]).agg({"Den_Area_um_sq": "median", "Den_Length_um": "median", "Den_Width_um": "median", "Dendrite_ID": "count", "Tile": "nunique"})
...
mito_norm_den_animal_df = pd.concat([mito_norm_den_animal_df, den_norm_stats_animal], axis=1)
...
stats_CA1_full, norm_CA1_full = get_stats_summary(data=CA1_data, data_col="Area_um_sq", x_label="Area (um2)", save_dir=dirName, group_name="CA1 Full", binsize=0.02, hist_comp="proportion", figsize=(8, 5), xlim=[0, 0.8], ylim=[0, 0.15])

# similar histogram for CA2 for the original mito data
stats_CA2_full, norm_CA2_full = get_stats_summary(data=CA2_data, data_col="Area_um_sq", x_label="Area (um2)", save_dir=dirName, group_name="CA2 Full", binsize=0.02, hist_comp="proportion", figsize=(8, 5), xlim=[0, 0.8], ylim=[0, 0.15])

# Get a similar histogram for the subsetted mito population with dendrites
stats_CA1_sub, norm_CA1_sub = get_stats_summary(data=CA1_data_sub, data_col="Area_um_sq", x_label="Area (um2)", save_dir=dirName, group_name="CA1 Sub", binsize=0.02, hist_comp="proportion", figsize=(8, 5), xlim=[0, 0.8], ylim=[0, 0.15])

# Get a similar histogram for the subsetted mito population with dendrites
stats_CA2_sub, norm_CA2_sub = get_stats_summary(data=CA2_data_sub, data_col="Area_um_sq", x_label="Area (um2)", save_dir=dirName, group_name="CA2 Sub", binsize=0.02, hist_comp="proportion", figsize=(8, 5), xlim=[0, 0.8], ylim=[0, 0.15])

# Histograms for Mito Ferets

# Start with the full dataset, histogram of CA1 across layers
stats_CA1_Feret, norm_CA1_feret = get_stats_summary(data=CA1_data, data_col="Feret_diam_um", x_label="Area (um2)", save_dir=dirName, group_name="CA1 Full", binsize=0.05, hist_comp="proportion", figsize=(8, 5), xlim=[0, 2], ylim=[0, 0.1])

# similar histogram for CA2 for the original mito data
stats_CA2_Feret, norm_CA2_feret = get_stats_summary(data=CA2_data, data_col="Feret_diam_um", x_label="Area (um2)", save_dir=dirName, group_name="CA2 Full", binsize=0.05, hist_comp="proportion", figsize=(8, 5), xlim=[0, 2], ylim=[0, 0.1])

# plot the CA1 histogram by layer for the subset of mitos in dendrites
stats_CA1_Feret_sub, norm_CA1_feret_sub = get_stats_summary(data=CA1_data_sub, data_col="Feret_diam_um", x_label="Feret's Diameter (um)", save_dir=dirName, group_name="CA1 Sub", binsize=0.05, hist_comp="proportion", figsize=(8, 5), xlim=[0, 2], ylim=[0, 0.1])

# plot the CA1 histogram by layer for the subset of mitos in dendrites
stats_CA2_Feret_sub, norm_CA2_feret_sub = get_stats_summary(data=CA2_data_sub, data_col="Feret_diam_um", x_label="Feret's Diameter (um)", save_dir=dirName, group_name="CA2 Sub", binsize=0.05, hist_comp="proportion", figsize=(8, 5), xlim=[0, 2], ylim=[0, 0.1])
...
stats_SR_den_length = get_stats_summary(data=den_data_SR, data_col="Den_Length_um", x_label="Length (um)", save_dir=dirName, hue_col = "Subregion", colors = ["dark rose", "ocean"], group_name="SR Dendrites", binsize=0.1, hist_comp="proportion", figsize=(8, 5), xlim=[0, 7], ylim=[0, 0.1])

# Dendrite length in SLM (CA1 vs CA2)
stats_SLM_den_length = get_stats_summary(data=den_data_SLM, data_col="Den_Length_um", x_label="Length (um)", save_dir=dirName, hue_col = "Subregion", colors = ["dark rose", "ocean"], group_name="SLM Dendrites", binsize=0.1, hist_comp="proportion", figsize=(8, 5), xlim=[0, 7], ylim=[0, 0.1])

# Dendrite area in SR (CA1 vs CA2)
stats_SR_den_area = get_stats_summary(data=den_data_SR, data_col="Den_Area_um_sq", x_label="Area (um2)", save_dir=dirName, hue_col = "Subregion", colors = ["dark rose", "ocean"], group_name="SR Dendrites", binsize=0.1, hist_comp="proportion", figsize=(8, 5), xlim=[0, 5], ylim=[0, 0.15])

# Dendrite area in SLM (CA1 vs CA2)
stats_SLM_den_area = get_stats_summary(data=den_data_SLM, data_col="Den_Area_um_sq", x_label="Area (um2)", save_dir=dirName, hue_col = "Subregion", colors = ["dark rose", "ocean"], group_name="SLM Dendrites", binsize=0.1, hist_comp="proportion", figsize=(8, 5), xlim=[0, 5], ylim=[0, 0.15])
...
# save file to CSV
area_summary_table.to_csv(os.path.join(dirName, str("mito_area_stats_by_animal_sub_den.csv")))
...
# save file to CSV
Feret_summary_table.to_csv(os.path.join(dirName, str("mito_diam_stats_by_animal_sub_den.csv")))
